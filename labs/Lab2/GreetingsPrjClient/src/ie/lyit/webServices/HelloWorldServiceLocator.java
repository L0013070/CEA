...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements ie.lyit.webServices.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/GreetingsPrj/services/HelloWorld";
    ...
    public ie.lyit.webServices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ie.lyit.webServices.HelloWorldSoapBindingStub _stub = new ie.lyit.webServices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ie.lyit.webServices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                ie.lyit.webServices.HelloWorldSoapBindingStub _stub = new ie.lyit.webServices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webServices.lyit.ie", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webServices.lyit.ie", "HelloWorld"));
        }
